...
exports.run = async (client, message, args) => {
  ...
  message.channel.send(new Discord.MessageEmbed().setTitle('İşte bu kadar!').setDescription(`Tag kanalı başarıyla açıldı. ${mentionChannel} kanalı olarak seçtiniz.`));
