...
**Örnek olarak**:
\`\`\`${client.ayarlar.prefix}sesmute @üyeetiketi 1m selam
${client.ayarlar.prefix}sesmute 686185592899633200 1m selam\`\`\``));
...
**Örnek olarak**:
\`\`\`${client.ayarlar.prefix}sesmute @üyetiketi 1m selam\`\`\``));
...
.setColor('#00001')
.setTitle('Lonely - Sesli Mute Sistem')
...
message.guild.channels.cache.get(logChannel).send(new Discord.MessageEmbed()
.setTitle('Lonely - Sesli  Mute Sistem').setColor('#f1c335')
