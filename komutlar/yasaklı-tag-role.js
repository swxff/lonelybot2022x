...
exports.run = async (client, message, args) => {
  ...
  message.channel.send(new Discord.MessageEmbed().setTitle('İşte bu kadar!').setDescription(`Yasaklı tag da kullanılacak: ${mentionRole} rolü olarak seçtiniz.`));
