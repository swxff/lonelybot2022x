...
exports.run = async (client, message, args) => {
  ...
  message.channel.send(new Discord.MessageEmbed().setTitle('İşte bu kadar!').setDescription(`Mute yetkisi olarak kullanılacak: ${mentionRole} rolü olarak seçtiniz.`));
