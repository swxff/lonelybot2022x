...
if(!args[0]) return message.channel.send(nn.setTitle('Bir hata oldu!').setDescription(`Bir **TAG** ve ya **SIMGE** koymayı unuttunuz.`).setImage('https://cdn.discordapp.com/attachments/942130580030636043/942131670579036210/003817fecc4cb9e310461f5977d2a2dc.gif')).then(a => a.delete({timeout: 10000}));
