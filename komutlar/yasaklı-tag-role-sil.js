...
exports.run = async (client, message, args) => {
  ...
  message.channel.send(new Discord.MessageEmbed().setTitle('İşte bu kadar!').setDescription('Ayarlanmış **YASAK TAG** rolü başarıyla silindi.'));
