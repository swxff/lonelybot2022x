...
exports.run = async (client, message, args) => {
  ...
  data.set(`login.role.${message.guild.id}`, mentionRole.id);
  message.channel.send(new Discord.MessageEmbed().setTitle('İşte bu kadar!').setDescription(`Kayıt mesaj sistemi başarıyla ${mentionRole} rolü olarak seçtiniz.`));
